    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 flex flex-col justify-end min-h-[220px] sm:min-h-[280px] lg:min-h-[320px]">
        <div className="page-hero-content">
          {eyebrow ? (
            <p className="text-white/90 text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase mb-2 drop-shadow-sm">
              {eyebrow}
            </p>
          ) : null}
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white text-balance max-w-4xl drop-shadow-md tracking-tight">
            {title}
          </h1>
          {subtitle ? (
            <p className="mt-3 text-base sm:text-lg text-white/92 max-w-2xl leading-relaxed drop-shadow">
              {subtitle}
            </p>
          ) : null}
